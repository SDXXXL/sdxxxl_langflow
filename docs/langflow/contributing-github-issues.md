# Get help and request enhancements | Langflow Documentation

- Support
- Get help and request enhancements

On this page# Get help and request enhancements

The Langflow GitHub repository is an integral part of the Langflow community.
...
The Issues page in the Langflow repository is actively updated with bugs and feature requests.

tipThe best way to promote a request or bug is to comment on an existing issue.
...
Use the Langflow repository's labels to help filter your search.

## GitHub discussions​

If you need help with your code or Langflow in general, you can visit the Langflow GitHub Discussions page or reach out through other Langflow community channels.
...
- Explain what exactly went wrong: Including error messages and descriptions of how your code failed, not just the fact that it failed.
...
The Langlow repository is a public GitHub repository and, therefore, subject to the GitHub Code of Conduct.
