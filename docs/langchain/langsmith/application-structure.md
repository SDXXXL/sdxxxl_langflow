...
<Tabs>
  <Tab title="Python">
    ...
    3. **A compiled graph**: [Compile](https://reference.langchain.com/python/langgraph/graphs/#langgraph.graph.state.StateGraph.compile) the graph to create a deployable application.
