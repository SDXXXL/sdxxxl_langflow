...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://reference.langchain.com/python/langgraph/">
      
      
        <link rel="prev" href="../langchain_classic/storage/">
    ...
    <title>LangGraph overview | LangChain Reference</title>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
  ...
  <a href="#langgraph" class="md-nav__link">
    <span class="md-ellipsis">
        ...
        <li class="md-nav__item">
  <a href="#prebuilt-components" class="md-nav__link">
    <span class="md-ellipsis">
      
        <span class="md-typeset">
          <span class="twemoji lg middle"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M6 3q-.75 0-1.2.6L3.5 5.2c-.3.4-.5.8-.5 1.3V19c0 1.1.9 2 2 2h8.3c-.2-.6-.3-1.3-.3-2 0-3.3 2.7-6 6-6 .7 0 1.4.1 2 .3V6.5c0-.5-.2-.9-.5-1.3l-1.4-1.7c-.2-.3-.6-.5-1.1-.5zm-.1 1h12l.9 1H5.1zM6 15h6v3H6zm15.3.8-3.6 3.6-1.6-1.6L15 19l2.8 3 4.8-4.8z"/></svg></span> Prebuilt components
        </span>
    ...
    <a href="https://github.com/langchain-ai/docs/tree/main/reference/python/docs/langgraph/index.md" title="Edit this page" class="md-content__button md-icon" rel="edit noopener" target="_blank">
  ...
  <h1>LangGraph reference</h1>

<p><a href="https://pypi.org/project/langgraph/#history" target="_blank" rel="noopener"><img alt="PyPI - Version" src="https://img.shields.io/pypi/v/langgraph?label=%20"></a>
<a href="https://opensource.org/licenses/MIT" target="_blank" rel="noopener"><img alt="PyPI - License" src="https://img.shields.io/pypi/l/langgraph"></a>
<a href="https://pypistats.org/packages/langgraph" target="_blank" rel="noopener"><img alt="PyPI - Downloads" src="https://img.shields.io/pepy/dt/langgraph"></a></p>
<p>Welcome to the LangGraph reference docs!</p>
<p>These pages detail the core interfaces you will use when building with LangGraph. Each section covers a different part of the ecosystem.</p>
<h2 id="langgraph"><span class="twemoji lg middle"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M6.099 5.88H17.9c3.364 0 6.1 2.745 6.1 6.12s-2.736 6.12-6.099 6.12H6.1C2.736 18.12 0 15.375 0 12s2.736-6.12 6.099-6.12m5.419 9.487c.148.156.367.148.561.108h.002c.09-.073-.038-.166-.16-.254-.074-.054-.145-.105-.166-.15.068-.083-.132-.27-.289-.417a2 2 0 0 1-.15-.151c-.11-.12-.155-.273-.2-.427a1.6 1.6 0 0 0-.11-.297c-.304-.708-.653-1.41-1.143-2.01-.315-.398-.674-.755-1.033-1.112-.232-.23-.463-.46-.683-.701-.226-.234-.362-.521-.499-.81-.114-.24-.228-.482-.396-.693-.507-.75-2.107-.955-2.342.105 0 .033-.01.054-.039.075a1.6 1.6 0 0 0-.342.334c-.238.332-.274.895.022 1.193l.001-.02c.01-.15.02-.29.139-.399.228.198.576.268.841.12.32.46.422 1.015.525 1.572.085.464.17.93.382 1.341l.014.022c.124.208.25.419.41.6.059.09.178.187.297.284.157.128.314.256.329.366v.146c-.001.29-.002.59.184.83.103.208-.15.418-.352.392a1 1 0 0 1-.354-.043c-.165-.04-.329-.08-.462-.003-.038.04-.091.042-.145.043-.064.002-.129.004-.167.07a.3.3 0 0 1-.045.066c-.042.051-.087.107-.033.149l.015-.011c.082-.063.16-.123.27-.085-.014.082.039.103.092.125l.027.012a.4.4 0 0 1-.008.057c-.009.046-.017.09.018.13a1 1 0 0 0 .046-.056c.037-.046.073-.094.139-.11.144.192.289.112.471.012.206-.114.459-.253.81-.056-.135-.007-.255.01-.345.121-.023.025-.042.054-.002.087.207-.135.294-.086.375-.04.06.032.115.063.212.024l.07-.037c.155-.084.314-.17.499-.14-.139.04-.188.127-.242.223a1 1 0 0 1-.094.143c-.021.021-.03.046-.007.082.29-.024.4-.098.548-.197.07-.047.15-.1.261-.157.124-.076.248-.028.368.02.13.05.255.1.371-.013.037-.035.083-.035.129-.036q.024 0 .05-.002c-.037-.194-.24-.191-.448-.189-.24.003-.483.005-.475-.295.222-.152.224-.415.226-.665q-.001-.09.005-.176c.163.092.336.163.508.234.162.066.323.133.474.215.157.254.404.59.732.568q.012-.037.026-.074a1 1 0 0 1 .059.014c.086.021.178.045.223-.057m6.429-2.886a1.014 1.014 0 0 0 1.729-.715 1.01 1.01 0 0 0-1.013-1.01 1 1 0 0 0-.364.068l-.58-.848-.405.278.583.851a1.01 1.01 0 0 0 .05 1.376m-1.818-2.744a1.014 1.014 0 0 0 1.42-.615 1.008 1.008 0 0 0-.845-1.293 1.015 1.015 0 0 0-1.095.712 1.01 1.01 0 0 0 .52 1.196m0 5.867a1.015 1.015 0 0 0 1.42-.615 1.008 1.008 0 0 0-.845-1.293 1.015 1.015 0 0 0-1.095.712 1.01 1.01 0 0 0 .52 1.196m.932-3.586v-.503h-1.55a1 1 0 0 0-.218-.412l.583-.864-.424-.28-.583.863a1 1 0 0 0-.333-.06c-.268 0-.525.106-.714.294a1.002 1.002 0 0 0 1.047 1.655l.583.864.42-.281-.579-.864c.104-.119.178-.26.217-.412z"/></svg></span> <code>langgraph</code><a class="headerlink" href="#langgraph" title="Copy anchor link to this section for reference">&para;</a></h2>
<p>The core APIs for the LangGraph open source library.</p>
<ul>
<li><a href="graphs/">Graphs</a>: Main graph abstraction and usage.</li>
<li><a href="func/">Functional API</a>: Functional programming interface for graphs.</li>
<li><a href="pregel/">Pregel</a>: Pregel-inspired computation model.</li>
<li><a href="checkpoints/">Checkpointing</a>: Saving and restoring graph state.</li>
<li><a href="store/">Storage</a>: Storage backends and options.</li>
<li><a href="cache/">Caching</a>: Caching mechanisms for performance.</li>
<li><a href="types/">Types</a>: Type definitions for graph components.</li>
<li><a href="runtime/">Runtime</a>: Runtime configuration and options.</li>
<li><a href="config/">Config</a>: Configuration options.</li>
<li><a href="errors/">Errors</a>: Error types and handling.</li>
<li><a href="constants/">Constants</a>: Global constants.</li>
<li><a href="channels/">Channels</a>: Message passing and channels.</li>
</ul>
<div class="admonition tip">
<p class="admonition-title">Model Context Protocol (MCP) support</p>
<p>To use MCP tools in your LangGraph application, check out <a href="../langchain_mcp_adapters/"><code>langchain-mcp-adapters</code></a>.</p>
</div>
<h2 id="prebuilt-components"><span class="twemoji lg middle"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M6 3q-.75 0-1.2.6L3.5 5.2c-.3.4-.5.8-.5 1.3V19c0 1.1.9 2 2 2h8.3c-.2-.6-.3-1.3-.3-2 0-3.3 2.7-6 6-6 .7 0 1.4.1 2 .3V6.5c0-.5-.2-.9-.5-1.3l-1.4-1.7c-.2-.3-.6-.5-1.1-.5zm-.1 1h12l.9 1H5.1zM6 15h6v3H6zm15.3.8-3.6 3.6-1.6-1.6L15 19l2.8 3 4.8-4.8z"/></svg></span> Prebuilt components<a class="headerlink" href="#prebuilt-components" title="Copy anchor link to this section for reference">&para;</a></h2>
<p>Higher-level abstractions for common workflows, agents, and other patterns.</p>
<ul>
<li><a href="agents/">Agents</a>: Built-in agent patterns.</li>
<li><a href="supervisor/">Supervisor</a>: Orchestration and delegation.</li>
<li><a href="swarm/">Swarm</a>: Multi-agent collaboration.</li>
</ul>
