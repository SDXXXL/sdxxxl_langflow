...
components:
  schemas:
    DeploymentCreateRequest:
      properties:
        ...
        source:
          ...
          title: Source
          description: >-
            Deploy from a GitHub repository (`github`) or a Docker image
            (`external_docker`).<br><br>Deploying from GitHub is only available
            for Cloud SaaS deployments. Deploying from a Docker image is only
            available for self-hosted deployments. This cannot be changed once
    ...
    SourceConfigRequest:
      properties:
        ...
        resource_spec:
          anyOf:
            - $ref: >-
                #/components/schemas/host__api__v2__schemas__deployments__ResourceSpec-Input
            - type: 'null'
        listener_id:
          anyOf:
            - type: string
      ...
      properties:
        ...
        langgraph_config_path:
          ...
          description: >-
            ...
            for the deployment.<br><br>When updating a deployment (`PATCH`),
            setting this field to a non-null value will trigger creation of a
            new revision. Only applicable for `github` source.
        image_uri:
          anyOf:
            - type: string
            - type: 'null'
          ...
          description: >-
            ...
            value will trigger creation of a new revision. Only applicable for
            `external_docker` source.
      type: object
    ...
    SourceConfig:
      properties:
        ...
        resource_spec:
          anyOf:
            - $ref: >-
                #/components/schemas/host__api__v2__schemas__deployments__ResourceSpec-Output
            - type: 'null'
        listener_id:
          anyOf:
            - type: string
    ...
    host__api__v2__schemas__deployments__ResourceSpec-Input:
      properties:
        min_scale:
          anyOf:
            - type: integer
        ...
        cpu:
          ...
          title: CPU
          description: >-
            CPU request of a single replica of the deployment. If cpu_limit is
        ...
        cpu_limit:
          ...
          title: CPU Limit
          description: >-
            CPU limit of a single replica of the deployment. If not set,
            defaults to 2x cpu.
        memory_mb:
          anyOf:
            - type: integer
        ...
        queue_cpu:
          ...
          title: Queue CPU
          description: >-
            CPU request of a single replica of the queue deployment. If not
            provided, defaults to the same value as `cpu`. If queue_cpu_limit is
            not set, limit defaults to 2x this value.
        queue_cpu_limit:
          anyOf:
            - type: integer
          ...
          description: >-
            CPU limit of a single replica of the queue deployment. If not set,
            defaults to 2x queue_cpu.
        queue_memory_mb:
          anyOf:
            - type: integer
            - type: 'null'
        ...
        redis_memory_mb:
          ...
          description: Memory (MB) of the Redis deployment.
        labels:
          anyOf:
    ...
    host__api__v2__schemas__deployments__ResourceSpec-Output:
      properties:
        min_scale:
          anyOf:
            - type: integer
